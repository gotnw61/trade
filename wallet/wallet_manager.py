...
from config import trade_settings, WALLET_DATA_FILE, SOLANA_RPC_URL, TOKEN_PROGRAM_ID
...
class WalletManager:
    ...
    def __init__(self):
        ...
        # Asenkron cüzdan yükleme işlemini doğru şekilde çağırın
        asyncio.run(self.load_wallets())  # Güncellenmiş satır
    ...
    async def buy_token(self, mint_address, amount):
        ...
        Returns:
            str: İşlem hash'i
        """
        from network.api_client import execute_swap
...
async def get_available_balance():
    ...
    """
    from utils.trade_utils import is_night_mode
