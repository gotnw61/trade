...
from config import trade_settings, DEBUG_MODE
    ...
    try:
        ...
        if (trade_settings["volume_drop_detection_enabled"] and
            ...
            if in_position and calculate_profit_percentage(trade_bot, mint_address) > 0:
                from core.position_manager import take_partial_profit
...
async def _check_sell_signals(trade_bot, mint_address, current_price, whale_dump, whale_dump_amount,
    ...
    """
    from core.position_manager import calculate_profit_percentage, take_partial_profit
    from core.sell_logic import emergency_sell
