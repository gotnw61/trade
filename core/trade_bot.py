...
from gotnw_tradebot.wallet.wallet_manager import wallet_manager
from gotnw_tradebot.analysis.token_analyzer import EnhancedTokenAnalyzer

# Modüller
from gotnw_tradebot.core.websocket_manager import (
    start_enhanced_websocket, add_token_subscription
)
from gotnw_tradebot.core.trade_window import (
...
from gotnw_tradebot.core.price_manager import (
...
from gotnw_tradebot.core.position_manager import (
    calculate_profit_percentage, take_partial_profit, update_position
)
from gotnw_tradebot.core.trade_analyzer import analyze_token_dynamics
from gotnw_tradebot.core.monitor_messages import (
...
class TradeBot:
    ...
    async def display_menu(self):
        ...
        from gotnw_tradebot.core.menu_handler import display_menu
