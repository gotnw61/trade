...
from analysis.price_patterns import (
    detect_dip,
    detect_pump_pattern,
    detect_dump_pattern,
    detect_micro_pump,
...
from analysis.token_models import (
...
class EnhancedTokenAnalyzer(TokenAnalyzer):
    ...
    def prepare_dataset(self, mint_addresses=None, label_window=10, feature_windows=[5, 10, 20, 50, 100]):
        ...
        from analysis.token_models import prepare_dataset
    ...
    def predict_with_ensemble(self, mint_address):
        ...
        try:
            ...
            is_pump_bool = bool(is_pump)
            pump_proba_final = pump_proba
            return is_pump_bool, pump_proba_final
        except Exception as e:
